                ...
                <div class="conteiner-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbar-1">
                         <ul class="nav navbar-nav">
                            ...
                            <li><a href="detallePartido.jsp">Detalles de Partido</a>
                            </li>
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  <label class="control-label col-xs-3" ><font face="arial-black" size="4">Minuto:</font></label>
                    <div class="col-xs-7">
                    <input type="number" class="form-control" name="min" value="" placeholder="Ingrese Minuto" required>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label class="control-label col-xs-3" ><font face="arial-black" size="4">Cantidad de Incidencias:</font></label>
                    <div class="col-xs-3">
                    <input type="number" class="form-control" name="cant" value="" placeholder="Ingrese Minuto" required>
                    </div>
                </div>
                <div class="form-group">
